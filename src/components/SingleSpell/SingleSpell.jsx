  ...
  return (
    <div className="spell" onClick={addSpell}>
      <div className="spell-img">
        <img
          src={`./assets/spell/${classes}/${value}.png`}
          className="spell-img_spell"
        />
        ...
        <p
          className={
            giftactive
              ...
              : 'spell-content_description active'
          }
        >
          {description}
        </p>
        <div
          className={
            giftactive
              ...
              : 'spell-content_gift-block'
          }
        >
          <h3 onClick={openGift}>
            Dons<i className={giftactive ? 'arrow active' : 'arrow'}></i>
          </h3>
          <div
            className={
              giftactive ? 'spell-content_gifts active' : 'spell-content_gifts'
            }
          >
            {gifts.map((gift) => (
