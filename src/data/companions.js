export default [
  {
    ...
    gifts: [
      ...
      {
        description: 'Quand ce personnage subit des dégâts : Prend son ENVOL.',
      },
    ],
  },
  {
    value: 'championne-perimee',
  ...
  },
  {
    ...
    gifts: [
      ...
      {
        description: 'APPARITION : +3 AURAS COEUR DE FLAMME.',
      },
    ],
  },
  {
    ...
    gifts: [
      ...
      {
        description:
          'APPARITION : Ajoute le sort REFLET DE MASSER à votre main.',
      },
    ],
  },
  {
    ...
    description:
      'ATTAQUE : -2 PA au coût du prochain sort de MÉCANISME ou de PIÈGE que vous jouez.',
    rare: 'Commun',
    element: 'fire',
    cost: 3,
    stats: [
  ...
  },
  {
    ...
    gifts: [
      ...
      {
        description: 'APPARITION : +3 AURAS GRIFFES JOUEUSES.',
      },
    ],
  },
  {
